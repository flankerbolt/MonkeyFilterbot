...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text="<b>ʜᴇʏ ᴅᴜᴅᴇ 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ᴏɴ ᴏᴜʀ <a href=https://t.me/ipapkornns>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ​👇</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ​ ", url=f"https://t.me/ipapkornns")]])
    )
...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⚡ ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ⚡", url=f"https://t.me/ipapkorn_officials/26")
    ])
    try:
...
async def select_language(bot, query):
    ...
    btn = [[
        ...
        InlineKeyboardButton("ʜɪɴᴅɪ", callback_data=f"lang#{userid}#hindi"),
        InlineKeyboardButton("ʜɪɴ", callback_data=f"lang#{userid}#hin")
    ],[
        InlineKeyboardButton("ᴇɴɢʟɪꜱʜ", callback_data=f"lang#{userid}#eng"),
        InlineKeyboardButton("ᴇɴɢ", callback_data=f"lang#{userid}#english")
    ],[
        InlineKeyboardButton("ᴛᴀᴍɪʟ", callback_data=f"lang#{userid}#tamil"),
        InlineKeyboardButton("ᴛᴀᴍ", callback_data=f"lang#{userid}#tam")
    ],[
        InlineKeyboardButton("ᴛᴇʟᴜɢᴜ", callback_data=f"lang#{userid}#telugu"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                if clicked == typed:
                    ...
                    return await query.answer(f"Hᴇʏ {query.from_user.first_name}, ʙʀᴏ ʏᴇ ᴛᴇʀɪ ᴍᴏᴠɪᴇ ɴʜɪ ʜ ᴋʜᴜᴅ sᴇᴀʀᴄʜ ᴋᴀʀ 🤗", show_alert=True)
        ...
        buttons = [[
            InlineKeyboardButton('🍷 ᴍᴀɴᴀɢᴍᴇɴᴛ 🍷', callback_data='helpz')
        ], [     
        ...
        buttons = [[
             InlineKeyboardButton('🛏️ ᴋɪᴄᴋ', callback_data='kick'),
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("📞 ᴄᴏɴᴛᴀᴄᴛ", url="t.me/DoraTheExplorer02")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        ...
        InlineKeyboardButton("ʟᴀɴɢᴜᴀɢᴇ", callback_data=f"select_lang#{message.from_user.id}")
    ])
...
async def advantage_spell_chok(client, msg):
    ...
    try:
        ...
        button = [[
                   ...
                   InlineKeyboardButton('📌 Rᴇǫᴜᴇꜱᴛ Hᴇʀᴇ', url ='https://t.me/ipapkorn_officials/30')
        ]]
        if NO_RESULTS_MSG:
